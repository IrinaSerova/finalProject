jQuery(document).ready(function ($) {
    ...
    $(document).on("click", ".tabsAside .menu div", function () {
        ...
        if (!$(this).is("active")) {
            ...
            var listItemHeight = $(".tabsAside ul").find("li:eq(" + numberIndex + ")").innerHeight();
    ...
    $('#gallery img').each(function () {
        ...
        //end preload images portion
        //image swap
        $(this).hover(function () { //mouse neter function
                $(this).attr('src', preloadImg.src);
            }, function () { //mouse leave fucntion
